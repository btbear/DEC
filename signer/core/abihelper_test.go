...
func TestNewUnpacker(t *testing.T) {
	...
	testcases := []unpackTest{
		...
		}, { // https://github.com/DEWH/wiki/wiki/DEWH-Contract-ABI#examples
...
func TestCalldataDEWHoding(t *testing.T) {
...
[
	...
	for _, hexdata := range []string{
		...
		// From https://github.com/DEWH/wiki/wiki/DEWH-Contract-ABI
		...
		if err == nil {
			t.Errorf("Expected DEWHoding to fail: %s", hexdata)
		}
	}
