...
import (
	...
	"github.com/DEC/go-DEC/cmd/internal/browser"
...
const issueURL = "https://github.com/DEC/go-DEC/issues/new"

// reportBug reports a bug by opening a new URL to the go-DEC GH issue
