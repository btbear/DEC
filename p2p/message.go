...
// DEWHode parses the RLP content of a message into
// the given value, which must be a pointer.
//
// For the DEWHoding rules, please see package rlp.
func (msg Msg) DEWHode(val interface{}) error {
	s := rlp.NewStream(msg.Payload, uint64(msg.Size))
	if err := s.DEWHode(val); err != nil {
