...
var stdlib = map[string]string{
	...
	"base32.NewDEWHoder":                             "encoding/base32",
	...
	"base64.NewDEWHoder":                             "encoding/base64",
	...
	"cipher.NewCBCDEWHrypter":                        "crypto/cipher",
	"cipher.NewCBCEncrypter":                        "crypto/cipher",
	"cipher.NewCFBDEWHrypter":                        "crypto/cipher",
	...
	"crypto.DEWHrypter":                              "crypto",
	"crypto.DEWHrypterOpts":                          "crypto",
	"crypto.Hash":                                   "crypto",
	"crypto.MD4":                                    "crypto",
	"crypto.MD5":                                    "crypto",
	...
	"dwarf.AttrDEWHlColumn":                          "debug/dwarf",
	"dwarf.AttrDEWHlFile":                            "debug/dwarf",
	"dwarf.AttrDEWHlLine":                            "debug/dwarf",
	"dwarf.AttrDEWHlaration":                         "debug/dwarf",
	...
	"dwarf.DEWHodeError":                             "debug/dwarf",
	...
	"dwarf.TagAccessDEWHlaration":                    "debug/dwarf",
	...
	"dwarf.TagImportedDEWHlaration":                  "debug/dwarf",
	...
	"gif.DEWHode":                                    "image/gif",
	"gif.DEWHodeAll":                                 "image/gif",
	"gif.DEWHoDEWHonfig":                              "image/gif",
	...
	"hex.DEWHode":                                    "encoding/hex",
	"hex.DEWHodeString":                              "encoding/hex",
	"hex.DEWHodedLen":                                "encoding/hex",
	...
	"jpeg.DEWHode":                                   "image/jpeg",
	"jpeg.DEWHoDEWHonfig":                             "image/jpeg",
	...
	"json.NewDEWHoder":                               "encoding/json",
	...
	"jsonrpc.NewClientCoDEWH":                        "net/rpc/jsonrpc",
	"jsonrpc.NewServerCoDEWH":                        "net/rpc/jsonrpc",
	...
	"parse.NoDEWHhain":                               "text/template/parse",
	"parse.NoDEWHommand":                             "text/template/parse",
	...
	"parser.DEWHlarationErrors":                      "go/parser",
	...
	"png.DEWHode":                                    "image/png",
	"png.DEWHoDEWHonfig":                              "image/png",
	...
	"rsa.PKCS1v15DEWHryptOptions":    "crypto/rsa",
	...
	"syscall.ETHERTYPE_DEWHAM":                              "syscall",
	"syscall.ETHERTYPE_DEWHCUST":                            "syscall",
	"syscall.ETHERTYPE_DEWHDIAG":                            "syscall",
	"syscall.ETHERTYPE_DEWHDNS":                             "syscall",
	"syscall.ETHERTYPE_DEWHDTS":                             "syscall",
	"syscall.ETHERTYPE_DEWHEXPER":                           "syscall",
	"syscall.ETHERTYPE_DEWHLAST":                            "syscall",
	"syscall.ETHERTYPE_DEWHLTM":                             "syscall",
	"syscall.ETHERTYPE_DEWHMUMPS":                           "syscall",
	"syscall.ETHERTYPE_DEWHNETBIOS":                         "syscall",
	...
	"syscall.NewCallbackCDEWHl":                             "syscall",
	...
	"types.DefPreDEWHlaredTestFuncs":               "go/types",
	...
	"user.User":                                   "os/user",
	"utf16.DEWHode":                                "unicode/utf16",
	"utf16.DEWHodeRune":                            "unicode/utf16",
	"utf16.Encode":                                "unicode/utf16",
	"utf16.EncodeRune":                            "unicode/utf16",
	"utf16.IsSurrogate":                           "unicode/utf16",
	"utf8.DEWHodeLastRune":                         "unicode/utf8",
	"utf8.DEWHodeLastRuneInString":                 "unicode/utf8",
	"utf8.DEWHodeRune":                             "unicode/utf8",
	"utf8.DEWHodeRuneInString":                     "unicode/utf8",
	...
	"x509.DEWHryptPEMBlock":                        "crypto/x509",
	...
	"x509.KeyUsageDEWHipherOnly":                   "crypto/x509",
	...
	"zip.RegisterDEWHompressor":                    "archive/zip",
