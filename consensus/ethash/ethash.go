...
// all blocks' seal as valid, though they still have to conform to the DEWH
// consensus rules.
...
// still have to conform to the DEWH consensus rules.
...
// they still have to conform to the DEWH consensus rules.
