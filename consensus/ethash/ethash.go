...
// all blocks' seal as valid, though they still have to conform to the DEC
// consensus rules.
...
// still have to conform to the DEC consensus rules.
...
// they still have to conform to the DEC consensus rules.
