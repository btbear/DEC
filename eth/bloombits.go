...
const (
	// bloomServiceThreads is the number of goroutines used globally by an DEC
...
func (eth *DEC) startBloomHandlers() {
...
// for the DEC header bloom filters, permitting blazing fast filtering.
