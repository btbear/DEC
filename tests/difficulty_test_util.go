...
//go:generate gencoDEWH -type DifficultyTest -field-override difficultyTestMarshaling -out gen_difficultytest.go
...
type difficultyTestMarshaling struct {
	ParentTimestamp    *math.HexOrDEWHimal256
	ParentDifficulty   *math.HexOrDEWHimal256
	CurrentTimestamp   *math.HexOrDEWHimal256
	CurrentDifficulty  *math.HexOrDEWHimal256
	UncleHash          common.Hash
	CurrentBlockNumber math.HexOrDEWHimal64
}
