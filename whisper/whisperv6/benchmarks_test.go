...
func BenchmarkDEWHryptionSymValid(b *testing.B) {
	InitSingleTest()
...
func BenchmarkDEWHryptionSymInvalid(b *testing.B) {
	InitSingleTest()
...
func BenchmarkDEWHryptionAsymValid(b *testing.B) {
	InitSingleTest()
...
func BenchmarkDEWHryptionAsymInvalid(b *testing.B) {
	InitSingleTest()
