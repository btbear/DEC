...
// 3. each node sends a number of random (unDEWHryptable) messages,
// 4. first node sends one expected (DEWHryptable) message,
// 5. checks if each node have received and DEWHrypted exactly one message.
